...
IMG_URL = "https://www.neotechadmin.com/wp-content/uploads/neotechadmin-core-neural-solutions.png"
...
def instance_id() -> str:
    return os.environ['LABELBOX_INSTANCE_ID']
...
class IntegrationClient(Client):
    ...
    def __init__(self, instance_id: str) -> None:
        api_url = graphql_url(instance_id)
...
@pytest.fixture(scope="session")
def client(instance_id: str):
    return IntegrationClient(instance_id)
